...
@testset "PersistenceLandscape operations" begin
    ...
    @testset "addition" begin
        ...
        @test pl0 + pl2 ==
        [[MyPair(0, 0), MyPair(1, 1), MyPair(2, 1), MyPair(3, 0)]] |> PersistenceLandscape
        @test pl2 + pl3 ==
        ...
        @test (pl6 + pl0) ==
        [[MyPair(0, 0), MyPair(1, 1), MyPair(2, 3),MyPair(3, 1), MyPair(4, 0)],[MyPair(1, 0), MyPair(2, 1), MyPair(3, 0)]] |>
              PersistenceLandscape
        ...
        @test (pl7 + pl8) ==
              [
            [MyPair(0, 0), MyPair(1, 1), MyPair(2, 2), MyPair(3, 2), MyPair(4, 2), MyPair(6, 0)],
            [
                MyPair(0, 0),
                MyPair(1, 1),
                MyPair(2, 0),
...
@testset "substraction test" begin
    ...
    @test diff_result.land[1][4].second == 0
    ...
    diff_result = two_layer_landscape_a - two_layer_landscape_a
    for k in 1:2
    ...
    diff_result = two_layer_landscape_b - two_layer_landscape_b
    for k in 1:2
        for land_point in diff_result.land[k]
            @test land_point.second == 0
        end
    ...
    diff_result1 = two_layer_landscape_a - two_layer_landscape_b
    diff_result2 = two_layer_landscape_b - two_layer_landscape_a
